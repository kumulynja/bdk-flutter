...
abstract class coreApiImplPlatform extends BaseApiImpl<coreWire> {
  ...
  CrossPlatformFinalizerArg
      get rust_arc_decrement_strong_count_MutexWalletAnyDatabasePtr => wire
          ._rust_arc_decrement_strong_count_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabasePtr;
  ...
  MutexWalletAnyDatabase
      dco_decode_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase(
          dynamic raw);
  ...
  @protected
  MutexWalletAnyDatabase
      sse_decode_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase(
          SseDeserializer deserializer);
  ...
  void cst_api_fill_to_wire_bdk_wallet(
    ...
    wireObj.ptr =
        cst_encode_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase(
            apiObj.ptr);
  }
  ...
  @protected
  int cst_encode_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase(
  ...
  @protected
  void sse_encode_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase(
...
class coreWire implements BaseWire {
  ...
  void wire__crate__api__blockchain__bdk_blockchain_new(
    int port_,
    ffi.Pointer<wire_cst_blockchain_config> blockchain_config,
  ) {
    return _wire__crate__api__blockchain__bdk_blockchain_new(
      port_,
      blockchain_config,
    );
  }

  late final _wire__crate__api__blockchain__bdk_blockchain_newPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(
                  ffi.Int64, ffi.Pointer<wire_cst_blockchain_config>)>>(
      'frbgen_bdk_flutter_wire__crate__api__blockchain__bdk_blockchain_new');
  late final _wire__crate__api__blockchain__bdk_blockchain_new =
      _wire__crate__api__blockchain__bdk_blockchain_newPtr.asFunction<
          void Function(int, ffi.Pointer<wire_cst_blockchain_config>)>();

  void wire__crate__api__descriptor__bdk_descriptor_as_string(
    int port_,
  ...
  void wire__crate__api__descriptor__bdk_descriptor_as_string_private(
    int port_,
    ffi.Pointer<wire_cst_bdk_descriptor> that,
  ) {
    return _wire__crate__api__descriptor__bdk_descriptor_as_string_private(
      port_,
      that,
    );
  }

  late final _wire__crate__api__descriptor__bdk_descriptor_as_string_privatePtr =
      _lookup<
              ffi.NativeFunction<
                  ffi.Void Function(
                      ffi.Int64, ffi.Pointer<wire_cst_bdk_descriptor>)>>(
          'frbgen_bdk_flutter_wire__crate__api__descriptor__bdk_descriptor_as_string_private');
  late final _wire__crate__api__descriptor__bdk_descriptor_as_string_private =
      _wire__crate__api__descriptor__bdk_descriptor_as_string_privatePtr
          .asFunction<
              void Function(int, ffi.Pointer<wire_cst_bdk_descriptor>)>();
  ...
  void wire__crate__api__key__bdk_descriptor_public_key_as_string(
    int port_,
  ...
  void wire__crate__api__key__bdk_descriptor_secret_key_as_string(
    int port_,
  ...
  void wire__crate__api__key__bdk_mnemonic_as_string(
    int port_,
  ...
  void wire__crate__api__types__bdk_address_as_string(
    int port_,
  ...
  void wire__crate__api__types__bdk_address_to_qr_uri(
    int port_,
    ffi.Pointer<wire_cst_bdk_address> that,
  ) {
  ...
  void
      rust_arc_increment_strong_count_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase(
    ffi.Pointer<ffi.Void> ptr,
  ) {
    return _rust_arc_increment_strong_count_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase(
      ptr,
    );
  }

  late final _rust_arc_increment_strong_count_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabasePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
          'frbgen_bdk_flutter_rust_arc_increment_strong_count_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase');
  late final _rust_arc_increment_strong_count_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase =
      _rust_arc_increment_strong_count_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabasePtr
          .asFunction<void Function(ffi.Pointer<ffi.Void>)>();

  void
      rust_arc_decrement_strong_count_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase(
    ffi.Pointer<ffi.Void> ptr,
  ) {
    return _rust_arc_decrement_strong_count_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase(
      ptr,
    );
  }

  late final _rust_arc_decrement_strong_count_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabasePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
          'frbgen_bdk_flutter_rust_arc_decrement_strong_count_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase');
  late final _rust_arc_decrement_strong_count_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase =
      _rust_arc_decrement_strong_count_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabasePtr
          .asFunction<void Function(ffi.Pointer<ffi.Void>)>();
