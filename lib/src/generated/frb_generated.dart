...
class core extends BaseEntrypoint<coreApi, coreApiImpl, coreWire> {
  ...
  @override
  int get rustContentHash => 1784916616;
...
abstract class coreApi extends BaseApi {
  ...
  Future<BdkBlockchain> crateApiBlockchainBdkBlockchainNew(
      {required BlockchainConfig blockchainConfig});

  Future<String> crateApiDescriptorBdkDescriptorAsString(
      {required BdkDescriptor that});

  Future<String> crateApiDescriptorBdkDescriptorAsStringPrivate(
      {required BdkDescriptor that});
  ...
  Future<String> crateApiKeyBdkDescriptorPublicKeyAsString(
  ...
  Future<String> crateApiKeyBdkDescriptorSecretKeyAsString(
  ...
  Future<String> crateApiKeyBdkMnemonicAsString({required BdkMnemonic that});
  ...
  Future<String> crateApiPsbtBdkPsbtSerialize({required BdkPsbt that});

  Future<String> crateApiPsbtBdkPsbtTxid({required BdkPsbt that});

  Future<String> crateApiTypesBdkAddressAsString({required BdkAddress that});
  ...
  Future<String> crateApiTypesBdkAddressToQrUri({required BdkAddress that});
...
class coreApiImpl extends coreApiImplPlatform implements coreApi {
  ...
  Future<BdkBlockchain> crateApiBlockchainBdkBlockchainNew(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        return wire.wire__crate__api__blockchain__bdk_blockchain_new(
            port_, arg0);
      },
      codec: DcoCodec(
      ...
      constMeta: kCrateApiBlockchainBdkBlockchainNewConstMeta,
      argValues: [blockchainConfig],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiBlockchainBdkBlockchainNewConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiDescriptorBdkDescriptorAsStringPrivate(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        var arg0 = cst_encode_box_autoadd_bdk_descriptor(that);
        return wire
            .wire__crate__api__descriptor__bdk_descriptor_as_string_private(
                port_, arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_String,
      ...
      constMeta: kCrateApiDescriptorBdkDescriptorAsStringPrivateConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiDescriptorBdkDescriptorAsStringPrivateConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiKeyBdkDescriptorPublicKeyAsString(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        return wire.wire__crate__api__key__bdk_descriptor_public_key_as_string(
            port_, arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_String,
  ...
  Future<String> crateApiKeyBdkDescriptorSecretKeyAsString(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        return wire.wire__crate__api__key__bdk_descriptor_secret_key_as_string(
            port_, arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_String,
  ...
  Future<String> crateApiKeyBdkMnemonicAsString({required BdkMnemonic that}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        return wire.wire__crate__api__key__bdk_mnemonic_as_string(port_, arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_String,
        decodeErrorData: null,
  ...
  Future<String> crateApiTypesBdkAddressAsString({required BdkAddress that}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        return wire.wire__crate__api__types__bdk_address_as_string(port_, arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_String,
        decodeErrorData: null,
  ...
  Future<String> crateApiTypesBdkAddressToQrUri({required BdkAddress that}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        var arg0 = cst_encode_box_autoadd_bdk_address(that);
        return wire.wire__crate__api__types__bdk_address_to_qr_uri(port_, arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_String,
        decodeErrorData: null,
  ...
  BdkWallet dco_decode_bdk_wallet(dynamic raw) {
    ...
    if (arr.length != 1)
      throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return BdkWallet(
      ptr: dco_decode_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase(
          arr[0]),
    );
  }
...
// ignore: invalid_use_of_internal_member
  ...
  void sse_encode_bdk_wallet(BdkWallet self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase(
        self.ptr, serializer);
  }
