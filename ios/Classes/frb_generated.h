...
void frbgen_bdk_flutter_wire__crate__api__blockchain__bdk_blockchain_new(int64_t port_,
                                                                         struct wire_cst_blockchain_config *blockchain_config);

void frbgen_bdk_flutter_wire__crate__api__descriptor__bdk_descriptor_as_string(int64_t port_,
                                                                               struct wire_cst_bdk_descriptor *that);

void frbgen_bdk_flutter_wire__crate__api__descriptor__bdk_descriptor_as_string_private(int64_t port_,
                                                                                       struct wire_cst_bdk_descriptor *that);

void frbgen_bdk_flutter_wire__crate__api__descriptor__bdk_descriptor_max_satisfaction_weight(int64_t port_,
                                                                                             struct wire_cst_bdk_descriptor *that);
...
void frbgen_bdk_flutter_wire__crate__api__key__bdk_descriptor_public_key_as_string(int64_t port_,
                                                                                   struct wire_cst_bdk_descriptor_public_key *that);
...
void frbgen_bdk_flutter_wire__crate__api__key__bdk_descriptor_secret_key_as_public(int64_t port_,
                                                                                   struct wire_cst_bdk_descriptor_secret_key *ptr);

void frbgen_bdk_flutter_wire__crate__api__key__bdk_descriptor_secret_key_as_string(int64_t port_,
                                                                                   struct wire_cst_bdk_descriptor_secret_key *that);
...
void frbgen_bdk_flutter_wire__crate__api__key__bdk_descriptor_secret_key_secret_bytes(int64_t port_,
                                                                                      struct wire_cst_bdk_descriptor_secret_key *that);

void frbgen_bdk_flutter_wire__crate__api__key__bdk_mnemonic_as_string(int64_t port_,
                                                                      struct wire_cst_bdk_mnemonic *that);
...
void frbgen_bdk_flutter_wire__crate__api__psbt__bdk_psbt_extract_tx(int64_t port_,
                                                                    struct wire_cst_bdk_psbt *ptr);

void frbgen_bdk_flutter_wire__crate__api__psbt__bdk_psbt_fee_amount(int64_t port_,
                                                                    struct wire_cst_bdk_psbt *that);

void frbgen_bdk_flutter_wire__crate__api__psbt__bdk_psbt_fee_rate(int64_t port_,
                                                                  struct wire_cst_bdk_psbt *that);
...
void frbgen_bdk_flutter_wire__crate__api__psbt__bdk_psbt_json_serialize(int64_t port_,
                                                                        struct wire_cst_bdk_psbt *that);

void frbgen_bdk_flutter_wire__crate__api__psbt__bdk_psbt_serialize(int64_t port_,
                                                                   struct wire_cst_bdk_psbt *that);

void frbgen_bdk_flutter_wire__crate__api__psbt__bdk_psbt_txid(int64_t port_,
                                                              struct wire_cst_bdk_psbt *that);

void frbgen_bdk_flutter_wire__crate__api__types__bdk_address_as_string(int64_t port_,
                                                                       struct wire_cst_bdk_address *that);
...
void frbgen_bdk_flutter_wire__crate__api__types__bdk_address_is_valid_for_network(int64_t port_,
                                                                                  struct wire_cst_bdk_address *that,
                                                                                  int32_t network);

void frbgen_bdk_flutter_wire__crate__api__types__bdk_address_network(int64_t port_,
                                                                     struct wire_cst_bdk_address *that);

void frbgen_bdk_flutter_wire__crate__api__types__bdk_address_payload(int64_t port_,
                                                                     struct wire_cst_bdk_address *that);

void frbgen_bdk_flutter_wire__crate__api__types__bdk_address_script(int64_t port_,
                                                                    struct wire_cst_bdk_address *ptr);

void frbgen_bdk_flutter_wire__crate__api__types__bdk_address_to_qr_uri(int64_t port_,
                                                                       struct wire_cst_bdk_address *that);

void frbgen_bdk_flutter_wire__crate__api__types__bdk_script_buf_empty(int64_t port_);
...
void frbgen_bdk_flutter_rust_arc_increment_strong_count_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase(const void *ptr);

void frbgen_bdk_flutter_rust_arc_decrement_strong_count_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase(const void *ptr);
...
static int64_t dummy_method_to_enforce_bundling(void) {
    ...
    dummy_var ^= ((int64_t) (void*) frbgen_bdk_flutter_rust_arc_decrement_strong_count_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase);
    ...
    dummy_var ^= ((int64_t) (void*) frbgen_bdk_flutter_rust_arc_increment_strong_count_RustOpaque_stdsyncMutexbdkWalletbdkdatabaseanyAnyDatabase);
    ...
    dummy_var ^= ((int64_t) (void*) frbgen_bdk_flutter_wire__crate__api__blockchain__bdk_blockchain_new);
    dummy_var ^= ((int64_t) (void*) frbgen_bdk_flutter_wire__crate__api__descriptor__bdk_descriptor_as_string);
    dummy_var ^= ((int64_t) (void*) frbgen_bdk_flutter_wire__crate__api__descriptor__bdk_descriptor_as_string_private);
